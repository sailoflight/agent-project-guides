...
10. Compatible channels, generation leases, selected CLI, project CLI, self-contained, source-worktree schema 2, full-local dangerous, and migration finalization are deferred.
