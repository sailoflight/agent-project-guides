...
export function installBootstrap(projectRoot, packageRoot, descriptor, options = {}) {
  ...
  writeFileAtomic(preview.rootFile, preview.after, { mode: preview.ownership.before_mode ?? 0o644, temporary });
...
export function restoreOwnedFile(projectRoot, ownership) {
  ...
  if (!ownership.before_exists) {
    ...
    writeFileAtomic(file, before, { mode: ownership.before_mode ?? 0o644, temporary });
  }
